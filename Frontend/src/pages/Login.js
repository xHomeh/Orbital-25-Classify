...
function Login() {
    return (
        <div class="flex justify-center items-center h-screen bg-zinc-900">
            <div class="w-96 p-6 shadow-lg bg-white rounded-md form-box active" id="login-form">
            ...
            <div class="mt-5">
                <button type="submit" class="border-2 border-orange-600 bg-orange-600 text-white py-1 w-full rounded-md hover:bg-transparent hover:text-orange-600 font-semibold">Login</button>
            </div>
            <div class="mt-3 flex">
                <label for="register" class="block test-base mb-2">New to Classify?</label>
                <a href="#" onclick="showForm('register-form')" class="text-sky-700 font-semibold px-1">Sign Up</a>
            </div>
            </div>
            ...
            <div class="mt-3 flex">
                ...
                <a href="#" onclick="showForm('login-form')" class="text-sky-700 font-semibold px-1">Log In</a>
            </div>
            </div>
