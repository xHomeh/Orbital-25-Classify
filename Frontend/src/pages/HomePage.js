    ...
    return (
        <div className="bg-neutral-800 min-h-screen">
            ...
            <div className="flex gap-2">
                <div className="flex flex-col gap-2 text-gray-400 mt-3">
                    <Link to="/" className="text-orange-600 hover:underline px-4">Timetable</Link>
                    <Link to="/friends" className="hover:text-orange-600 hover:underline px-4">Friends</Link>
                    <Link to="/settings" className="hover:text-orange-600 hover:underline px-4">Settings</Link>
                </div>
                <div className="border-2 px-3 mt-3 text-gray-400">Timetable</div>
            </div>
